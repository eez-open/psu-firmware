...
enum DataEnum {
    ...
    DATA_ID_SYS_INFO_DATE_YEAR,
    DATA_ID_SYS_INFO_DATE_MONTH,
    DATA_ID_SYS_INFO_DATE_DAY,
    DATA_ID_SYS_INFO_TIME_HOUR,
    DATA_ID_SYS_INFO_TIME_MINUTE,
    DATA_ID_SYS_INFO_TIME_SECOND
};
