...
enum DataEnum {
    ...
    DATA_ID_CALIBRATION_CHANNEL_LABEL,
    DATA_ID_CALIBRATION_CHANNEL_SHORT_LABEL,
    DATA_ID_CALIBRATION_CHANNEL_STATUS,
    DATA_ID_CALIBRATION_CHANNEL_STATE,
    DATA_ID_CALIBRATION_CHANNEL_DATE,
    DATA_ID_CALIBRATION_CHANNEL_REMARK,
    DATA_ID_CALIBRATION_CHANNEL_PARAMS_ENABLED,
    DATA_ID_CALIBRATION_CHANNEL_STEP_NUM,
    DATA_ID_CALIBRATION_CHANNEL_STEP_STATUS,
    DATA_ID_CALIBRATION_CHANNEL_STEP_VALUE,
    DATA_ID_CALIBRATION_CHANNEL_STEP_PREV_ENABLED,
    DATA_ID_CALIBRATION_CHANNEL_STEP_NEXT_ENABLED,
    DATA_ID_KEYPAD_TEXT,
    DATA_ID_KEYPAD_CAPS,
