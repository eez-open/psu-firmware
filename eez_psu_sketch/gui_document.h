...
enum DataEnum {
    ...
    DATA_ID_CHANNEL_U_TRIGGER_MODE,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE,
    DATA_ID_CHANNEL_I_TRIGGER_MODE,
    ...
    DATA_ID_CHANNEL_LISTS_CLEAR_MENU_ENABLED,
    DATA_ID_CHANNEL_LISTS_INSERT_ROW_BELOW_ENABLED,
    DATA_ID_CHANNEL_LISTS_CLEAR_ROW_ENABLED,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED,
    DATA_ID_CHANNEL_LISTS_CLEAR_ROWS_ENABLED
};
...
enum PagesEnum {
    ...
    PAGE_ID_CH_SETTINGS_LISTS_CLEAR_MENU,
