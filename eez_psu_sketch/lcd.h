...
public:
    ...
    void drawStr(const char *text, int textLength, int x, int y, int clip_x1, int clip_y1, int clip_x2, int clip_y2, font::Font &font);
    int measureStr(const char *text, int textLength, font::Font &font, int max_width = 0);

private:
    font::Font font;

    int8_t drawGlyph(int x1, int y1, int clip_x1, int clip_y1, int clip_x2, int clip_y2, uint8_t encoding);
