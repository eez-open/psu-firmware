...
#define CH_PARAMS_U_30V_R5B9 0.0f,  0.0f,  30.0f, 30.0f,      0.01f,      0.1f,       5.0f,       0.15f,         14.1f,         28.0f,         25.0f,     CH_PARAMS_OVP
#define CH_PARAMS_U_40V_R5B9 0.0f,  0.0f,  40.0f, 40.0f,      0.01f,      0.1f,       5.0f,       0.15f,         19.1f,         38.0f,         25.0f,     CH_PARAMS_OVP
#define CH_PARAMS_U_50V_R5B9 0.0f,  0.0f,  50.0f, 50.0f,      0.01f,      0.1f,       5.0f,       0.15f,         24.1f,         48.0f,         25.0f,     CH_PARAMS_OVP
...
#define CH_PARAMS_I_3A_R5B9 0.0f,  0.0f,  3.125f, 3.125f,     0.01f,      0.01f,      1.0f,       0.05f,         1.525f,        3.0f,          0.05f,      CH_PARAMS_OCP
...
#define CH_PARAMS_30V_3A_R5B9        CH_PARAMS_U_30V_R5B9, CH_PARAMS_I_3A_R5B9, true, CH_PARAMS_OPP_DELAY,  0.0f,  60.0f,  90.0f, 38.0f, 3.125f, 25.0f, 90.0f
#define CH_PARAMS_40V_3A_R5B9        CH_PARAMS_U_40V_R5B9, CH_PARAMS_I_3A_R5B9, true, CH_PARAMS_OPP_DELAY,  0.0f,  80.0f, 120.0f, 48.0f, 3.125f, 25.0f, 120.0f
#define CH_PARAMS_50V_3A_R5B9        CH_PARAMS_U_50V_R5B9, CH_PARAMS_I_3A_R5B9, true, CH_PARAMS_OPP_DELAY,  0.0f, 100.0f, 150.0f, 58.0f, 3.125f, 25.0f, 150.0f
#define CH_PARAMS_30V_5A_R5B9        CH_PARAMS_U_30V_R5B9, CH_PARAMS_I_5A_R5B9, true, CH_PARAMS_OPP_DELAY,  0.0f, 100.0f, 120.0f, 38.0f,   5.0f, 25.0f, 120.0f
...
#define CH_PARAMS_50V_5A_R5B9        CH_PARAMS_U_50V_R5B9, CH_PARAMS_I_5A_R5B9, true, CH_PARAMS_OPP_DELAY,  0.0f, 160.0f, 200.0f, 58.0f,   5.0f, 25.0f, 200.0f
