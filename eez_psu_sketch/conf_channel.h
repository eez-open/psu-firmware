...
#define CH_BOARD_REVISION_R4B43A_PARAMS CH_BOARD_REVISION_R4B43A, IOEXP_IODIR_R4B43A
#define CH_BOARD_REVISION_R5B6B_PARAMS  CH_BOARD_REVISION_R5B6B, IOEXP_IODIR_R5B6B
...
#define CH_PARAMS_30V_3A    CH_PARAMS_U_30V, CH_PARAMS_I_3A, true, CH_PARAMS_OPP_DELAY, 10.0f,  60.0f,  90.0f, 42.0f, 1.0f, 20.0f
#define CH_PARAMS_40V_3A    CH_PARAMS_U_40V, CH_PARAMS_I_3A, true, CH_PARAMS_OPP_DELAY, 10.0f,  80.0f, 120.0f, 42.0f, 1.0f, 20.0f
#define CH_PARAMS_50V_3A    CH_PARAMS_U_50V, CH_PARAMS_I_3A, true, CH_PARAMS_OPP_DELAY, 10.0f, 100.0f, 150.0f, 42.0f, 1.0f, 20.0f
#define CH_PARAMS_30V_5A    CH_PARAMS_U_30V, CH_PARAMS_I_5A, true, CH_PARAMS_OPP_DELAY, 10.0f, 100.0f, 120.0f, 42.0f, 1.0f, 20.0f
#define CH_PARAMS_40V_5A    CH_PARAMS_U_40V, CH_PARAMS_I_5A, true, CH_PARAMS_OPP_DELAY, 10.0f, 150.0f, 160.0f, 52.0f, 1.0f, 20.0f
#define CH_PARAMS_50V_5A    CH_PARAMS_U_50V, CH_PARAMS_I_5A, true, CH_PARAMS_OPP_DELAY, 10.0f, 150.0f, 160.0f, 62.0f, 1.0f, 20.0f
