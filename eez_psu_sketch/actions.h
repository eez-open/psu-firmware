...
enum ActionsEnum {
    ...
    ACTION_ID_CH_SETTINGS_ADV_TRIGGER_EDIT_VOLTAGE_TRIGGER_MODE,
    ACTION_ID_CH_SETTINGS_ADV_TRIGGER_EDIT_VOLTAGE_TRIGGER_VALUE,
    ACTION_ID_CH_SETTINGS_ADV_TRIGGER_EDIT_CURRENT_TRIGGER_MODE,
    ACTION_ID_CH_SETTINGS_ADV_TRIGGER_EDIT_CURRENT_TRIGGER_VALUE,
