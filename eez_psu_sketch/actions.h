...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_CHANNEL_LISTS_CLEAR_MENU,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_ABOVE,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_BELOW,
    ACTION_ID_CHANNEL_LISTS_CLEAR_ROW,
    ACTION_ID_CHANNEL_LISTS_CLEAR_COLUMN,
    ACTION_ID_CHANNEL_LISTS_CLEAR_ROWS,
    ACTION_ID_CHANNEL_LISTS_CLEAR_ALL,
    ACTION_ID_CHANNEL_START_LIST,
    ACTION_ID_CHANNEL_DISABLE_LIST,
